...
BEGIN INSERT INTO YUKENDHIRAN.ORDER_BASE.T_INVOICE (
...
MERGE INTO YUKENDHIRAN.ORDER_BASE.T_CUSTOMER AS target USING (
  ...
  FROM 
    YUKENDHIRAN.ORDER_ANALYSIS.V_SALES_ORDER_HDR_CORE 
  GROUP BY 
    CUSTOMER_ID
  ...
  FROM 
    (
      ...
      FROM 
        ...
        INNER JOIN YUKENDHIRAN.ORDER_ANALYSIS.V_CUSTOMER_CORE AS cu ON soh.CUSTOMER_ID = cu.CUSTOMER_ID
    ) AS co 
